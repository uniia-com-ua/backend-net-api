...
namespace UniiaAdmin.WebApi.Controllers
{
    ...
    public class PublicationTypeController : ControllerBase
    {
        ...
        {
			var publicationType = await _applicationUnitOfWork.FindAsync<PublicationType>(id);
        ...
        {
			var publicationTypes = await _applicationUnitOfWork.GetPagedAsync<PublicationType>(skip, take, sort);
